...
<img src="Sem título.png" alt="Imagem de destaque do portfólio">
...
- **CSS3** — Estilização com design limpo e responsivo.
...
```bash
git clone https://github.com/SamuellAguiar/portfolio.git
```
